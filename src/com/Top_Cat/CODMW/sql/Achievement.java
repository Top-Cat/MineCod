...
public enum Achievement {
    ...
    COLLATERAL_FRAG(103, Stat.OTHER, -1, "Collateral Frag", "Get 2 kills with 1 grenade", Material.SNOW_BLOCK),
    KNIFE_KILLS_5(104, Stat.KNIFE_KILLS, 5, "Innit, bruv!", "Get 5 kills with the knife", Material.IRON_SWORD),
    KNIFE_KILLS_10(105, Stat.KNIFE_KILLS, 10, "Bangin', mate!", "Get 10 kills with the knife", Material.IRON_SWORD),
    KNIFE_KILLS_25(106, Stat.KNIFE_KILLS, 25, "Come on, blud!", "Get 25 kills with the knife", Material.IRON_SWORD),
    KNIFE_KILLS_50(107, Stat.KNIFE_KILLS, 50, "Well sick, boi!", "Get 50 kills with the knife", Material.IRON_SWORD),
    KNIFE_KILLS_100(108, Stat.KNIFE_KILLS, 100, "I is well 'ard!", "Get 100 kills with the knife", Material.IRON_SWORD),
    AIMBOT(109, Stat.OTHER, -1, "Aimbot", "Hit 15 shots in a row without missing", Material.BOW),
    GRENADE_KILLS_5(110, Stat.GRENADE_KILLS, 5, "Nade King", "Get 5 grenade kills", Material.SNOW_BALL),
    GRENADE_KILLS_10(111, Stat.GRENADE_KILLS, 10, "Nade Master", "Get 10 grenade kills", Material.SNOW_BALL),
    GRENADE_KILLS_25(112, Stat.GRENADE_KILLS, 25, "Nade lord", "Get 25 grenade kills", Material.SNOW_BALL),
    GRENADE_KILLS_50(113, Stat.GRENADE_KILLS, 50, "I love nades", "Get 50 grenade kills", Material.SNOW_BALL),
    GRENADE_KILLS_100(114, Stat.GRENADE_KILLS, 100, "Holy hand grenade", "Get 100 grenade kills", Material.SNOW_BALL),
    KILLIONAIRE(115, Stat.KILLS, 1000000, "Killionaire", "Get 1,000,000 kills, wait... you got this? Seriously???? You're kinda sad :/", Material.COOKIE),
    RAPID_FIRE(116, Stat.OTHER, -1, "Rapid Fire", "Kill 2 people within 5 seconds", Material.ARROW),
    DEFYING_GRAVITY(117, Stat.OTHER, -1, "Defying gravity", "Kill an enemy who is in midair", Material.WOOL),
    FLAG_GRENADE(118, Stat.OTHER, -1, "Flag grenade", "Kill an enemy carrying the flag with a grenade", Material.SNOW_BLOCK),
    CARE_GET_5(119, Stat.CAREPACKAGES_ACHIEVED, 5, "Care package ETA 5 minutes", "Get 5 care packages", Material.CHEST),
    CARE_GET_10(120, Stat.CAREPACKAGES_ACHIEVED, 10, "Care package ETA 2 minutes", "Get 10 care packages", Material.CHEST),
    CARE_GET_25(121, Stat.CAREPACKAGES_ACHIEVED, 25, "Care package arriving", "Get 25 care packages", Material.CHEST),
    CARE_GET_50(122, Stat.CAREPACKAGES_ACHIEVED, 50, "Care package deploying", "Get 50 care packages", Material.CHEST),
    CARE_GET_100(123, Stat.CAREPACKAGES_ACHIEVED, 100, "Another ammo restock", "Get 100 care packages", Material.CHEST),
    NECROKILLIAC(124, Stat.DEAD_KILLS, 15, "Necrokilliac", "Kill 15 players while you're dead", Material.LAVA_BUCKET),
    SAVIOUR(125, Stat.FLAG_CARRIER_KILLED, 5, "Saviour", "Kill 5 enemies carrying the flag", Material.IRON_ORE),
    AERIAL_AIM(126, Stat.OTHER, -1, "Aerial Aim", "Take a chopper down", Material.OBSIDIAN),
    FLAG_CAPTURE_5(127, Stat.FLAG_CAPTURES, 5, "Return fire", "Capture the flag 5 times", Material.MILK_BUCKET),
    FLAG_CAPTURE_10(128, Stat.FLAG_CAPTURES, 10, "Coming home", "Capture the flag 10 times", Material.MILK_BUCKET),
    FLAG_CAPTURE_25(129, Stat.FLAG_CAPTURES, 25, "Bringing home the bacon", "Capture the flag 25 times", Material.MILK_BUCKET),
    FLAG_CAPTURE_50(130, Stat.FLAG_CAPTURES, 50, "Running the prize", "Capture the flag 50 times", Material.MILK_BUCKET),
    FLAG_CAPTURE_100(131, Stat.FLAG_CAPTURES, 100, "Round-tripping", "Capture the flag 100 times", Material.MILK_BUCKET),
    DESTROY_SENTRY_5(132, Stat.SENTRIES_DESTROYED, 5, "I don't blame you...", "Destroy 5 sentries", Material.DISPENSER),
    DESTROY_SENTRY_10(133, Stat.SENTRIES_DESTROYED, 10, "Shutting down", "Destroy 10 sentries", Material.DISPENSER),
    DESTROY_SENTRY_25(134, Stat.SENTRIES_DESTROYED, 25, "Critical error", "Destroy 25 sentries", Material.DISPENSER),
    DESTROY_SENTRY_50(135, Stat.SENTRIES_DESTROYED, 50, "No hard feelings...", "Destroy 50 sentries", Material.DISPENSER),
    DESTROY_SENTRY_100(136, Stat.SENTRIES_DESTROYED, 100, "I don't hate you...", "Destroy 100 sentries", Material.DISPENSER),
    AROUND_THE_WORLD(137, Stat.MAPS_PLAYED, 15, "Around the world", "Play on all 4 official maps", Material.MAP),
    NO_HITTER(138, Stat.OTHER, -1, "No Hitter", "Steal and then capture your flag without firing a shot", Material.RED_ROSE),
    BOW_KILLS_1000(139, Stat.BOW_KILLS, 1000, "Bow-ner", "Get 1000 bow kills", Material.BOW),
    ;
